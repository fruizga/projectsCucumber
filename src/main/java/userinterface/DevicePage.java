...
public class DevicePage extends PageObject {
    ...
    public static final Target TITLE = Target.the("where we select " +
            "the computer OS").located(By.xpath("//*[text()=\"Tell us about your devices\"]"));
    public static final Target COMPUTER_OS = Target.the("where we select " +
            "the computer OS").located(By.xpath("//*[@id=\"web-device\"]/div[1]/div[2]/div/div[1]/span/i"));
    public static final Target OS_OPTIONS = Target.the("" +
            " we select " +
            "the computer OS").located(By.xpath("//*[@id=\"web-device\"]/div[1]/div[2]/div/input[1]"));
    ...
    public static final Target VERSION_OPTIONS = Target.the("where we select " +
            "the computer OS").located(By.xpath("//*[@id=\"web-device\"]/div[2]/div[2]/div/input[1]"));
    public static final Target LANGUAGE = Target.the("where we select " +
            "the OS language").located(By.xpath("//*[@id=\"web-device\"]/div[3]/div[2]/div/div[1]/span"));
    public static final Target LANGUAGE_OPTIONS = Target.the("where we select " +
            "the OS language").located(By.xpath("//*[@id=\"web-device\"]/div[3]/div[2]/div/input[1]"));
